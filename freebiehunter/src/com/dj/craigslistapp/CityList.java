...
public class CityList extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		while (iterator.hasNext()) {
			...
			URLS[i] = city_name.substring(city_name.indexOf("http"),
					city_name.indexOf("\">"));
			cityNames[i] = city_name.substring((city_name.indexOf("\">") + 2),
					city_name.indexOf("</a>")); //
			i++;
		}
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String[] citiesWithSubLocations = app
						.getCitiesWithSubLocations();
				...
				if (!big) {
					...
					Intent a = new Intent(CityList.this,
							FreebiehunterActivity.class);
					startActivity(a);
				}
