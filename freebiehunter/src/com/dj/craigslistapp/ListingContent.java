...
public class ListingContent extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!userbody.equals("") || userbody != null) {
			if (!app.isPic())
				...
				// S ArrayList<ImageView> imagesArray = new
				// ArrayList<ImageView>();
				try {
					images = source.getElementById("userbody")
							.getAllElementsByClass("iw").get(0)
							.getAllStartTags("img");
					subImages = source.getElementById("userbody")
							.getAllElementsByClass("iw").get(0)
							.getAllStartTags("a");
		...
		Element email = source.getFirstElementByClass("returnemail")
				.getFirstElement("a");
		if (email != null)
		...
		callButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (!returnPhone.equals("")) {
					...
					Toast.makeText(ListingContent.this,
							"cant make call as dialed", Toast.LENGTH_SHORT)
							.show();
			}
		});
		...
		emailButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (!returnEmail.equals("") && !returnEmail.equals("none")) {
					...
					i.putExtra(Intent.EXTRA_SUBJECT, "subject of email"); // pull
																			// subject
																			// ...
					i.putExtra(Intent.EXTRA_TEXT, "body of email"); // eventually
																	// ask user
																	// for
																	// default
																	// resonse
					...
					Toast.makeText(ListingContent.this,
							"cant create email to:  " + returnEmail,
							Toast.LENGTH_SHORT).show();
	...
	private Source getSource() {
		...
		if (source == null) {
			Toast.makeText(ListingContent.this, "Error in getting content",
					Toast.LENGTH_SHORT).show();
