...
public class FreebieApp extends Application {
	...
	private String[] citiesWithSubLocations = { "phoenix", "los angeles",
			"san diego", "san francisco bay area", "District of Columbia",
			"fort lauderdale", "ft myers / SW florida", "south florida",
			"tampa bay area", "atlanta", "hawaii", "chicago", "boston",
			"detroit metro", "minneapolis / st paul", "new york city",
			"portland", "dallas / fort worth", "seattle-tacoma" };
	public int test = 0;
